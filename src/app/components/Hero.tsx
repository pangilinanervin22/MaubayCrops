    ...
    <section>
      <div className="bg-hero bg-cover bg-center h-hero bg-no-repeat flex items-center justify-center">
        <section className="h-full p-5 flex flex-col items-center space-y-6 lg:space-y-16">
          ...
          <button className="bg-gradient-button px-6 py-4 text-center transition duration-500 bg-[length:200%_auto] hover:border-white hover:border-2 text-white shadow-button shadow-white rounded-md whitespace-nowrap border-2 border-primary w-40 text-xl">
            SHOP NOW
          </button>
        </section>
      </div>
